...
logging.info("Загрузка OPEN AI ключа")

tavily_key = os.getenv("TAVILY_API_KEY")
logging.info("Загрузка Tavily ключа")
...
question = """Find 10 new scenarios for the use and implementation of Generative AI in companies over the past month (August 2025). Present the results in a table with the following columns:
